...
module.exports.campuses = [{
  ...
  sort: 1,
  name: "Campus Cité",
  initial: { lat: 48.854383, lng: 2.346719 },
  southwest: { lat: 48.830000, lng: 2.300000 },
  northeast: { lat: 48.875000, lng: 2.380000 },
...
},
{
  ...
  sort: 2,
  name: "Campus Orsay",
  initial: { lat: 48.862134, lng: 2.307909 },
  southwest: { lat: 48.845000, lng: 2.285000 },
  northeast: { lat: 48.875000, lng: 2.330000 },
  photo: "https://picsum.photos/500/500"
}]
    ...
    features: [
      {
        ...
        properties: {
          name: [
            { value: "Bibliothèque Universitaire La Madeleine", langcode: "fr" },
            { value: "La Madeleine University Library", langcode: "en" }
          ],
          description: [
            { value: "Du Mercredi au vendredi : 9h00-12h00 - 12h45-16h15\n Vendredi 8h30-13h00", langcode: "fr" },
            { value: "Wednesday to Friday: 9am-12pm - 12:45pm-4:15pm\n Friday 8:30am-1pm", langcode: "en" }
          ],
          site: "Campus Cité",
          icon: {
    ...
    features: [
      {
        ...
        properties: {
          name: [
            { value: "Restaurant Universitaire Campus 1", langcode: "fr" },
            { value: "Campus 1 University Restaurant", langcode: "en" }
          ],
          description: [
            { value: "Lundi-Vendredi 11h30 – 13h30", langcode: "fr" },
            { value: "Monday-Friday 11:30am – 1:30pm", langcode: "en" }
          ],
          site: "Campus Cité",
          icon: {

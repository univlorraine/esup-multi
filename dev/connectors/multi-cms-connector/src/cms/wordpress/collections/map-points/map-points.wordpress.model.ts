...
class MapPointMapCategoryConnection {
  @Field(() => MapCategoryWordpress)
  node: MapCategoryWordpress;
}

@ObjectType()
class MapPointCampusConnection {
  @Field(() => CampusWordpress)
  node: CampusWordpress;
}

@ObjectType()
class MapPointMapIconConnection {
  @Field()
  node: MapIconWordpress;
}

@ObjectType()
export class MapPointWordpress {
  @Field()
  databaseId: number;
  ...
  @Field()
  mapPointLatitude: number;

  @Field()
  mapPointLongitude: number;
  ...
  translations: MapPointTranslationsWordpress[];
}

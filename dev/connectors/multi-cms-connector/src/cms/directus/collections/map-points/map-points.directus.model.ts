...
export class MapPointDirectus {
  ...
  @Field(() => [MapPointTranslationsDirectus])
  translations: MapPointTranslationsDirectus[];

  @Field(() => MapCategoryDirectus)
  category: MapCategoryDirectus;

  @Field(() => CampusDirectus)
  campus: CampusDirectus;

  @Field(() => MapIconDirectus)
  icon: MapIconDirectus;
}

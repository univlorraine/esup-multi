...
export default (): {
  ...
  return {
    ...
    keepAliveOptions,
    redisSocket: {
      host: process.env.MAIL_CALENDAR_SERVICE_CACHE_REDIS_HOST,
      port: parseInt(process.env.MAIL_CALENDAR_SERVICE_CACHE_REDIS_PORT),
    },
    redisPassword: process.env.MAIL_CALENDAR_SERVICE_CACHE_REDIS_PASSWORD,

 ...
 */
export function setUserAndCardEuData(data: UserAndCardEuData | null): void {
  userAndCardEuDataSubject.next(data);
}

/**
 * Clear the user and card data
 */
export function clearUserAndCardEuData(): void {
  userAndCardEuDataSubject.next(null);
}
